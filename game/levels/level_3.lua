...
function Lvl3:init()
    ...
    self.rectC = ObjectsBasic.RectangleObj:new(Geometry.Vector2:new(450, 440), Geometry.Rotation2.fromDegrees(90), Geometry.Vector2:new(50, 100), Color:new(0, 255, 127, 255))
